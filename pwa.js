...
const cacheName = 'Fixit9ExtraXPCampbell-2020-10-25 20:06:06.771027'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit9ExtraXPCampbell'.length) === 'Fixit9ExtraXPCampbell') {
